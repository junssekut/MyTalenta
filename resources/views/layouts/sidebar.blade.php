        ...
        <aside id="sidebar"
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    @if (auth()->user()->role &&
                            in_array(auth()->user()->role->name, ['pic_ppti', 'pic_ppbp', 'core_team', 'admin_core_team']))
                        <div class="pt-4">
                            <h3 class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Learning
                                Institute</h3>
                            <div class="mt-2 space-y-1">
                                <a href="{{ route('learning-institute') }}"
                                    class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('learning-institute') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }} transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <a href="#"
                                    ...
                                    <span
                                        class="ml-auto bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">12</span>
                                </a>
                    ...
                    @if (auth()->user()->role &&
                        ...
                        <div class="pt-4">
                            <h3 class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Rumah Talenta
                            </h3>
                            <div class="mt-2 space-y-1">
                                <a href="{{ route('rumah-talenta') }}"
                                    class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('rumah-talenta') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }} transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <a href="#"
                                    ...
                                    <span
                                        class="ml-auto bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">8</span>
                                </a>
                                ...
                                <a href="#"
                                    ...
                                    <span
                                        class="ml-auto bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full">3</span>
                                </a>
                            </div>
                        </div>
                    @endif
                ...
                <div class="p-4 border-t border-gray-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative">
                            ...
                            <!-- User Menu Dropdown -->
                            <div id="userMenu"
                                class="absolute bottom-full left-0 mb-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 hidden">
