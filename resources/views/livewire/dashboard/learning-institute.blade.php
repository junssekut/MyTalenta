            ...
            <div class="px-4 py-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <a href="{{ route('dashboard') }}"
                        class="p-2 rounded-lg bg-white bg-opacity-20 hover:bg-opacity-30 transition-colors">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="{{ route('booking.room') }}"
                        ...
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                    ...
                    <a href="{{ route('reports.create') }}"
                        class="group bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all duration-300">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @foreach ($announcements->take(2) as $announcement)
                            <div class="bg-white rounded-xl p-3 border border-blue-100">
                                ...
                                <p class="text-xs text-blue-600 font-medium">
                                    {{ $announcement->created_at->format('M d, Y') }}</p>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            {{ \App\Models\Booking::where('status', 'confirmed')->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            {{ \App\Models\Report::where('status', 'pending')->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($recentBookings as $booking)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Booked
                                    {{ $booking->room->name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    {{ $booking->created_at->format('M d, Y H:i') }}</td>
            ...
            <a href="{{ route('shuttle.booking') }}"
                ...
                <div class="text-center">
                    <svg class="w-8 h-8 text-green-600 mx-auto mb-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M8 5a1 1 0 011 1v3h2a1 1 0 110 2h-2v3a1 1 0 11-2 0v-3H5a1 1 0 110-2h2V6a1 1 0 011-1z"
                            clip-rule="evenodd" />
                    </svg>
