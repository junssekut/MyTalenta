        ...
        <div>
            <div class="flex justify-between items-center mb-2">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" wire:navigate class="text-sm text-blue-600 hover:text-blue-500 font-medium">
                        Lupa password?
                    </a>
                @endif
            </div>
            ...
            <div class="relative" x-data="{ show: false }">
                ...
                >
                    ...
                    <svg x-show="show" class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display: none;">
