    ...
    @if (auth()->user()->role->name === 'student')
        ...
        <div class="pb-20">
            ...
            <div class="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
                ...
                <!-- Gradient Overlay -->
                <div class="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-blue-900/30"></div>
                ...
                <div class="px-4 py-8 relative z-10">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <!-- Active Bookings -->
                        <div
                            class="bg-white bg-opacity-15 backdrop-blur-md rounded-2xl p-5 text-center border border-white border-opacity-20 shadow-lg hover:bg-opacity-20 transition-all duration-300">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-md">
                            ...
                            <div class="text-2xl font-bold text-white mb-1">{{ $activeBookings }}</div>
                            <div class="text-blue-100 text-xs font-medium uppercase tracking-wide">Active Bookings</div>
                        </div>
                        ...
                        <div
                            class="bg-white bg-opacity-15 backdrop-blur-md rounded-2xl p-5 text-center border border-white border-opacity-20 shadow-lg hover:bg-opacity-20 transition-all duration-300">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-green-400 to-green-600 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-md">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <div class="text-2xl font-bold text-white mb-1">{{ $attendanceRate }}<span
                                    class="text-lg">%</span></div>
                            <div class="text-blue-100 text-xs font-medium uppercase tracking-wide">Attendance Rate</div>
                        </div>
                    </div>

                    <!-- Today's Schedule -->
                    <div
                        class="bg-white bg-opacity-15 backdrop-blur-md rounded-2xl p-5 border border-white border-opacity-20 shadow-lg">
                        <h3 class="font-semibold mb-4 flex items-center text-white">
                            <div
                                class="w-8 h-8 bg-gradient-to-br from-purple-400 to-purple-600 rounded-lg flex items-center justify-center mr-3 shadow-md">
                        ...
                        <div class="space-y-3">
                            <div
                                class="flex items-center justify-between p-3 bg-white bg-opacity-10 rounded-xl border border-white border-opacity-10">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-blue-400 rounded-full"></div>
                                    <span class="text-white text-sm font-medium">Kuliah Pemrograman</span>
                                </div>
                                <span class="text-blue-100 text-sm font-medium">08:00 - 10:00</span>
                            </div>
                            <div
                                class="flex items-center justify-between p-3 bg-white bg-opacity-10 rounded-xl border border-white border-opacity-10">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-green-400 rounded-full"></div>
                                    <span class="text-white text-sm font-medium">Study Group</span>
                                </div>
                                <span class="text-blue-100 text-sm font-medium">14:00 - 16:00</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-4 py-6">
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <a href="{{ route('learning-institute') }}"
                        class="group bg-white rounded-2xl shadow-lg border border-gray-100 p-5 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden relative">
                        <div
                        ...
                        <h3
                            ...
                            Learning</h3>
                        <p class="text-gray-600 text-xs relative z-10">Institute</p>
                    </a>
                    ...
                    <a href="{{ route('rumah-talenta') }}"
                        ...
                        <div
                            class="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg relative z-10">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <h3
                            class="font-bold text-gray-900 text-sm mb-1 relative z-10 group-hover:text-green-600 transition-colors">
                            Rumah</h3>
                        <p class="text-gray-600 text-xs relative z-10">Talenta</p>
                    </a>
                    ...
                    <a href="{{ route('shuttle.booking') }}"
                        ...
                        <h3
                            ...
                            Shuttle</h3>
                        <p class="text-gray-600 text-xs relative z-10">Bus</p>
                    </a>
                    ...
                    <a href="{{ route('attendance.machine') }}"
                        ...
                        <div
                            class="w-14 h-14 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg relative z-10">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        ...
                        <h3
                            ...
                            Check</h3>
                        <p class="text-gray-600 text-xs relative z-10">Attendance</p>
                    </a>
                </div>
