...
new #[Layout('layouts.auth')] class extends Component {
    ...
    public function register(): void
    {
        ...
        $validated['role_id'] = Role::where('name', 'student')->first()->id;
        ...
        <div
            ...
            <div class="relative z-10">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">Masukkan detail Anda untuk membuat akun</p>
                </div>
                        ...
                        <div class="relative group">
                            <input wire:model="name" id="name" type="text" autofocus autocomplete="name"
                                ...
                                class="w-full pl-12 pr-4 py-4 border-2 rounded-2xl focus:ring-4 transition-all duration-300 bg-gray-50/70 focus:bg-white shadow-sm
                                    {{ $errors->has('name') ? 'border-red-300 focus:ring-red-100 focus:border-red-400' : 'border-gray-200 focus:ring-blue-100 focus:border-blue-400' }}
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <input wire:model="password_confirmation" id="password_confirmation" type="password"
                                ...
                                class="w-full pl-12 pr-12 py-4 border-2 rounded-2xl focus:ring-4 transition-all duration-300 bg-gray-50/70 focus:bg-white shadow-sm
                                    {{ $errors->has('password_confirmation') ? 'border-red-300 focus:ring-red-100 focus:border-red-400' : 'border-gray-200 focus:ring-blue-100 focus:border-blue-400' }}
                                    group-hover:shadow-md" />
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <div class="w-6 h-6 bg-gray-100 rounded-lg flex items-center justify-center">
                                    <svg class="h-4 w-4 text-gray-600" fill="none" stroke="currentColor"
                            ...
                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center">
                                <button type="button" onclick="togglePasswordConfirm()"
                                    class="w-6 h-6 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-200 group">
                                    <svg id="eye-icon-confirm" class="h-4 w-4 text-gray-600 group-hover:text-gray-800"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
