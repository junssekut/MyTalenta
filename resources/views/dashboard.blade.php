@extends(auth()->user()->role === 'mahasiswa' ? 'layouts.mobile' : 'layouts.sidebar')

@php
    $greeting = now()->format('H') < 12 ? 'Pagi' : (now()->format('H') < 15 ? 'Siang' : (now()->format('H') < 18 ? 'Sore' : 'Malam'));
    $motivationalQuotes = [
    ...
    <div class="px-4 py-6">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            ...
            <a href="{{ route('learning-institute') }}" 
               class="group bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-semibold text-gray-900 text-sm mb-1">Learning</h3>
                <p class="text-gray-600 text-xs">Institute</p>
            </a>
            ...
            <a href="{{ route('attendance.machine') }}" 
               class="group bg-white rounded-2xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all duration-300">
                <div class="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200 p-4">
            ...
            <div class="bg-white rounded-xl p-3 border border-blue-100">
                ...
                <p class="text-xs text-gray-600 mb-2">Orientation week starts next Monday. Don't forget to bring required documents.</p>
