            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" 
                               wire:model.live="facilityType" 
                               value="washing_machine_male" 
                               class="sr-only">
                        <div class="border rounded-lg p-6 text-center transition-all
                            {{ $facilityType == 'washing_machine_male' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300' }}">
                            <svg class="w-12 h-12 mx-auto mb-3 {{ $facilityType == 'washing_machine_male' ? 'text-blue-600' : 'text-gray-400' }}" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" 
                               wire:model.live="facilityType" 
                               value="washing_machine_female" 
                               class="sr-only">
                        <div class="border rounded-lg p-6 text-center transition-all
                            {{ $facilityType == 'washing_machine_female' ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-gray-300' }}">
                            <svg class="w-12 h-12 mx-auto mb-3 {{ $facilityType == 'washing_machine_female' ? 'text-pink-600' : 'text-gray-400' }}" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"/>
                            </svg>
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div class="border rounded-lg p-6 text-center transition-all
                            ...
                            <svg class="w-12 h-12 mx-auto mb-3 {{ $facilityType == 'kitchen' ? 'text-orange-600' : 'text-gray-400' }}" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <label class="relative cursor-pointer">
                        ...
                        <div class="border rounded-lg p-3 text-center transition-all
                            ...
                            <div class="text-xs mt-1">
                                @if($slot['available'])
                                    <span class="text-green-600">{{ $slot['available_count'] }} slot tersedia</span>
                                @else
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    ...
                    <ul class="text-sm text-yellow-700 space-y-1">
                        ...
                        <li>• Maksimal {{ $facilityType === 'washing_machine_male' ? $maxWashingMachineMale : $maxWashingMachineFemale }} slot per waktu</li>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-600">
                        ...
                        <p><strong>Tanggal:</strong> {{ $bookingDate ? \Carbon\Carbon::parse($bookingDate)->format('d M Y') : '-' }}</p>
                        <p><strong>Waktu:</strong> {{ $selectedTimeSlot ? $selectedTimeSlot . ' - ' . $this->getEndTime() : '-' }}</p>
                    </div>
                    <button type="submit" 
        ...
        <div class="mt-8 bg-white rounded-lg shadow">
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="font-semibold text-gray-900">{{ $this->getFacilityDisplayName($booking->facility_type) }}</h4>
